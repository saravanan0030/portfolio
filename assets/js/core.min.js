...
var Mi = {
    ...
    Basic: {
        ...
        scroller: function() {
            ...
            t.waypoint({
                ...
                offset: function() {
                    return a.hasClass("header-horizontal") ? -this.element.clientHeight + e + 2 : -this.element.clientHeight + 2
                }
            }), t.waypoint({
                handler: function(e) {
                    if ("down" == e) {
    ...
    o.submit(function (event) {
        ...
        e = $(this).find(".form-alert");
        t = $(this).find(".form-error");
        var a;

        e.hide().html();

        if (o.valid()) {
            emailjs.sendForm('service_obhtcnh', 'template_s0ai9l8', this)
                .then(function (response) {
                    a = '<div class="alert alert-success">✅ Thank you! Your message has been sent successfully.</div>';
                    e.html(a).show();
                    o[0].reset(); // Reset the form
                }, function (error) {
                    a = '<div class="alert alert-danger">❌ Something went wrong. Please try again later.</div>';
                    e.html(a).show();
                });
        }
    });
